...
__export(src_exports, {
  WelldoneWallet: () => WelldoneWallet,
  WelldoneWalletName: () => WelldoneWalletName
});
module.exports = __toCommonJS(src_exports);

// src/injected-welldone.ts
var import_sha3 = require("@noble/hashes/sha3");
var import_aptos = require("aptos");

// src/utils/CancelablePromise.ts
...
var WelldonePluginProvider = class {
  ...
  async signAndSubmitTransaction(transaction, options) {
    ...
    try {
      const client = new import_aptos.AptosClient(this.aptosNodeUrl(this._networkId));
      ...
      const rawTxnWithSalt = import_aptos.HexString.fromUint8Array(new Uint8Array([...hash.digest(), ...import_aptos.BCS.bcsToBytes(rawTx)])).hex();
