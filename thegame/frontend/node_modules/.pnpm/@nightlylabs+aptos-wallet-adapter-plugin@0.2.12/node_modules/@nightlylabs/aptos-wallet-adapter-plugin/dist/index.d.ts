...
declare class AptosPublicKey {
    private readonly hexString;
    static default(): AptosPublicKey;
    address(): string;
    asUint8Array(): Uint8Array;
    static fromBase58(base58string: string): AptosPublicKey;
    asString(): string;
    asPureHex(): string;
...
declare class NightlyWallet implements AdapterPlugin {
    ...
    disconnect(): Promise<void>;
    signTransaction(transaction: Types.TransactionPayload): Promise<{
...
export { NightlyWallet, NightlyWalletName };
