...
// node_modules/.pnpm/@aptos-labs+wallet-adapter-core@2.2.0/node_modules/@aptos-labs/wallet-adapter-core/dist/index.mjs
...
// node_modules/.pnpm/@pontem+wallet-adapter-plugin@0.2.0/node_modules/@pontem/wallet-adapter-plugin/dist/index.mjs
...
var PontemWallet = class {
  ...
  async signAndSubmitTransaction(transaction, options) {
    ...
    try {
      ...
      const response = await ((_b = this.provider) == null ? void 0 : _b.signAndSubmit(
        transaction,
        options
      ));
...
//# sourceMappingURL=@pontem_wallet-adapter-plugin.js.map
