...
// node_modules/.pnpm/@trustwallet+aptos-wallet-adapter@0.1.6/node_modules/@trustwallet/aptos-wallet-adapter/dist/index.mjs
var TrustWalletName = "TrustWallet";
var TrustWallet = class {
  constructor() {
    ...
    this.provider = typeof window !== "undefined" ? window.trustwallet : void 0;
  }
  async connect() {
    var _a, _b;
    try {
      ...
      if (!accountInfo)
        throw `${TrustWalletName} Address Info Error`;
      return accountInfo;
    } catch (error) {
      throw error;
    }
  ...
  async account() {
    ...
    if (!response)
      throw `${TrustWalletName} Account Error`;
    return response;
  }
  async disconnect() {
    var _a, _b;
  ...
  async network() {
    ...
    try {
      ...
      if (!response)
        throw `${TrustWalletName} Network Error`;
      return {
        name: response
      };
    } catch (error) {
  ...
  async onNetworkChange(callback) {
    ...
    try {
      ...
      await ((_b = (_a = this.provider) == null ? void 0 : _a.aptos) == null ? void 0 : _b.onNetworkChange(handleNetworkChange));
    } catch (error) {
      const errMsg = error.message;
      throw errMsg;
    }
  ...
  async onAccountChange(callback) {
    ...
    try {
      ...
      await ((_b = (_a = this.provider) == null ? void 0 : _a.aptos) == null ? void 0 : _b.onAccountChange(handleAccountChange));
    } catch (error) {
      console.log(error);
      const errMsg = error.message;
      throw errMsg;
...
//# sourceMappingURL=@trustwallet_aptos-wallet-adapter.js.map
