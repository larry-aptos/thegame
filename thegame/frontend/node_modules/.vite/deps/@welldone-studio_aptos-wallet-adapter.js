...
// node_modules/.pnpm/@welldone-studio+aptos-wallet-adapter@0.1.4/node_modules/@welldone-studio/aptos-wallet-adapter/dist/index.mjs
...
var WelldonePluginProvider = class {
  ...
  async signAndSubmitTransaction(transaction, options) {
    ...
    try {
      ...
      const rawTxnWithSalt = HexString.fromUint8Array(new Uint8Array([...hash.digest(), ...bcs_exports.bcsToBytes(rawTx)])).hex();
