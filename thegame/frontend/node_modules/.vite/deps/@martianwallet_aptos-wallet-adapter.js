...
// node_modules/.pnpm/@martianwallet+aptos-wallet-adapter@0.0.4/node_modules/@martianwallet/aptos-wallet-adapter/dist/index.mjs
...
var MartianWallet = class {
  ...
  async signAndSubmitTransaction(transaction, options) {
    ...
    try {
      ...
      const response = await ((_b = this.provider) == null ? void 0 : _b.signAndSubmitTransaction(tx));
      if (!response) {
